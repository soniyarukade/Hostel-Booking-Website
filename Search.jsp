...
try {
	...
	String sql ="select hostels.Id,Name,Address,Rating,location,img1,img2,img3 from hostels inner join hostel_image on hostels.Id = hostel_image.Id where Name = '"+h+"' or location ='"+h+"'";
