...
try
{
	 ...
	 ResultSet rs = st.executeQuery("select password from owner where email = '"+to+"'");
	 while(rs.next())
	 {
		 z=1;
...
if(z==1)
{
  response.sendRedirect("owner_login.jsp?msg=match");
}
else
{
	response.sendRedirect("owner_login.jsp?msg=notmatch");
}
}
...
catch(MessagingException mex)
{
	...
	mex.printStackTrace();
	response.sendRedirect("forgot_password_owner.jsp?msg=invalid");
}
%>
